...
document.querySelector('#app').innerHTML = `
  <div class="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 transition-colors duration-300">
    ...
    <div class="fixed top-4 right-4 z-50 flex gap-3">
      ...
      <button id="languageButton" class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-600 min-w-[120px]">
        <span id="currentLanguage" class="text-sm font-medium" data-i18n="header.language">🇩🇪 Deutsch</span>
      </button>
      
      <!-- Dark Mode Toggle Button -->
      <button id="darkModeToggle" class="bg-white dark:bg-gray-800 text-gray-800 dark:text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-600">
        ...
        <svg id="moonIcon" class="w-6 h-6 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 px-4">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <h1 class="text-5xl md:text-7xl font-serif font-bold text-gray-800 dark:text-white mb-6 transition-colors duration-300" data-i18n="hero.title">
          Wir heiraten!
        </h1>
        
        <div class="text-2xl md:text-3xl text-gray-700 dark:text-gray-200 mb-8 font-light transition-colors duration-300">
          <p class="mb-2" data-i18n="hero.names">Anna & Michell</p>
          <p class="text-xl text-rose-600 dark:text-rose-400" data-i18n="hero.date">03. Juni 2025</p>
        </div>
        
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed transition-colors duration-300" data-i18n="hero.description">
        ...
        <div class="flex justify-center space-x-4">
          <a href="#trauung" class="bg-rose-500 hover:bg-rose-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 transition duration-300" data-i18n="hero.buttons.ceremony">
            Zur Trauung
          </a>
          <a href="#fotos" class="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 transition duration-300" data-i18n="hero.buttons.photos">
            Zu den Fotos
          </a>
          <a href="#feier" class="bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg transform hover:scale-105 transition duration-300" data-i18n="hero.buttons.party">
            Zur Feier
          </a>
        </div>
      </div>
    ...
    <!-- Trauung Section -->
    <section id="trauung" class="py-20 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <h2 class="text-4xl font-serif font-bold text-gray-800 dark:text-white mb-4 transition-colors duration-300" data-i18n="ceremony.title">Die Trauung</h2>
          <p class="text-lg text-gray-600 dark:text-gray-300 transition-colors duration-300" data-i18n="ceremony.subtitle">Hier beginnt unser gemeinsamer Weg</p>
        </div>
        
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6">
            <div class="bg-rose-50 dark:bg-rose-900/20 p-6 rounded-lg border border-rose-200 dark:border-rose-800 transition-colors duration-300">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center transition-colors duration-300">
                <svg class="w-6 h-6 text-rose-500 dark:text-rose-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg border border-purple-200 dark:border-purple-800 transition-colors duration-300">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center transition-colors duration-300">
                <svg class="w-6 h-6 text-purple-500 dark:text-purple-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Fotos Section -->
    <section id="fotos" class="py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-indigo-900 dark:to-purple-900 transition-colors duration-300">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-16">
          <div class="flex justify-center mb-4">
          ...
          <h2 class="text-4xl font-serif font-bold text-gray-800 dark:text-white mb-4 transition-colors duration-300" data-i18n="photos.title">Fotos</h2>
          <p class="text-lg text-gray-600 dark:text-gray-300 transition-colors duration-300" data-i18n="photos.subtitle">Festhalten der schönsten Momente</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-colors duration-300">
            ...
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 text-center transition-colors duration-300" data-i18n="photos.gruppenfotos.title">Gruppenfotos</h3>
            <div class="space-y-2 text-sm">
              ...
              <p class="text-gray-700 dark:text-gray-300 mt-3 transition-colors duration-300" data-i18n="photos.gruppenfotos.description">
          ...
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-colors duration-300">
            ...
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 text-center transition-colors duration-300" data-i18n="photos.brautpaarfotos.title">Brautpaarfotos</h3>
            <div class="space-y-2 text-sm">
              <p class="text-gray-600 dark:text-gray-300 transition-colors duration-300">
              ...
              <p class="text-gray-700 dark:text-gray-300 mt-3 transition-colors duration-300" data-i18n="photos.brautpaarfotos.description">
          ...
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-colors duration-300">
            ...
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 text-center transition-colors duration-300" data-i18n="photos.sektempfang.title">Weitere Fotos</h3>
            <div class="space-y-2 text-sm">
              <p class="text-gray-600 dark:text-gray-300 transition-colors duration-300">
              ...
              <p class="text-gray-700 dark:text-gray-300 mt-3 transition-colors duration-300" data-i18n="photos.sektempfang.description">
        ...
        <div class="bg-indigo-50 dark:bg-indigo-900/20 p-8 rounded-lg border border-indigo-200 dark:border-indigo-800 text-center transition-colors duration-300">
          <div class="flex justify-center mb-4">
          ...
          <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 transition-colors duration-300" data-i18n="photos.availability.title">Verfügbarkeit</h3>
          <p class="text-gray-700 dark:text-gray-300 transition-colors duration-300" data-i18n="photos.availability.description">
    ...
    <!-- Feier Section -->
    <section id="feier" class="py-20 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-700 dark:to-purple-900 transition-colors duration-300">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-16">
          <div class="flex justify-center mb-4">
          ...
          <h2 class="text-4xl font-serif font-bold text-gray-800 dark:text-white mb-4 transition-colors duration-300" data-i18n="party.title">Die Hochzeitsfeier</h2>
          <p class="text-lg text-gray-600 dark:text-gray-300 transition-colors duration-300" data-i18n="party.subtitle">Lasst uns gemeinsam feiern!</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-6 order-1 md:order-2">
            ...
            <div class="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg border border-yellow-200 dark:border-yellow-800 transition-colors duration-300">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center transition-colors duration-300">
                <svg class="w-6 h-6 text-yellow-500 dark:text-yellow-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span data-i18n="party.info.title">Wichtige Infos</span>
              </h3>
              <p class="text-gray-700 dark:text-gray-300 transition-colors duration-300" data-i18n-list="party.info.items">
                • Dinner & Tanz<br>
                • Cocktailbar<br>
    ...
    <footer class="bg-gray-800 dark:bg-gray-900 text-white py-12 transition-colors duration-300">
      <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <h3 class="text-2xl font-serif font-bold mb-4" data-i18n="footer.names">Anna & Michell</h3>
        <p class="text-gray-300 dark:text-gray-400 mb-6 transition-colors duration-300" data-i18n="footer.message">
